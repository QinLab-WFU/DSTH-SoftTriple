...
from utils.centroids_generator import generate_centroids
...
class RelativeSimilarity(nn.Module):
    ...
    def update_centroids(self, centroids):
        ...
        self.c_star = self.centroids / torch.linalg.norm(self.centroids, dim=-1, keepdim=True)
...
class RelativePosition(nn.Module):
    def __init__(self, k, b, ignore_constant=True, device='cuda:0'):
